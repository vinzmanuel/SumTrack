...
export async function GET(
  ...
  const selectedBasis = resolveCollectorProfileSelectedBasis(period, url.searchParams.get("basis") ?? undefined);
  const data = await loadCollectorProfileData(access, routeParams.collectorId, period, selectedBasis);
