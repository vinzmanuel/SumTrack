...
import type { CollectionsAnalyticsAccessState } from "@/app/dashboard/collections/types";

export function resolveCollectionsPageAccess(
  ...
  return {
    view: "forbidden",
    message: "You are not authorized to view collections analytics.",
  };
}
